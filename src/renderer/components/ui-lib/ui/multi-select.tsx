  ...
  return (
    <div className={cn("relative", className)}>
      ...
      >
        ...
        {isOpen ? <ChevronUp className="h-5 w-5 text-[#737373]" /> : <ChevronDown className="h-5 w-5 text-[#737373]" />}
      </button>
      ...
      {isOpen && (
        <div className="absolute z-50 mt-2 w-full rounded-xl border border-[#E5E5E5] bg-white shadow-lg">
          <div className="max-h-[300px] overflow-y-auto p-2">
            {options.length === 0 ? (
              <div className="px-4 py-8 text-center text-sm text-[#737373]" style={{ fontFamily: "Montserrat" }}>
              ...
              options.map((option) => {
                ...
                return (
                  ...
                  >
                    ...
                    />
                    <span className="flex-1 text-sm text-[#000000]" style={{ fontFamily: "Montserrat" }}>
                      {option.label}
                    </span>
                  </div>
                )
